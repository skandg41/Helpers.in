...
import { updateJobSProfile } from "../../../actions/authActions";
import classnames from "classnames";

class UpdateJSProfile extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit = e => {
    ...
    console.log("inSub");
    this.props.updateJobSProfile(newUser, this.props.history);
...
UpdateJSProfile.propTypes = {
  updateJobSProfile: PropTypes.func.isRequired,
